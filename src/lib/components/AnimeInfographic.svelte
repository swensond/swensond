<script lang="ts">
  ...
  const NAME_KEY = 'nexhunters-anime-infographic-name';
  const THEME_KEY = 'nexhunters-anime-infographic-theme';
  ...
  async function exportPng() {
    ...
    try {
      ...
      link.download = `nexhunters-anime-${season.season.toLowerCase()}-${season.seasonYear}.png`;
      link.href = dataUrl;
      link.click();
    } catch (e) {
