...
<div class="space-y-6">
    <div class="card p-4">
        <h2 class="text-lg font-semibold mb-3">Owned Materials Management</h2>
            ...
            {#each materials as material (material.id)}
                <div class="border border-border rounded-lg p-4">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
                        <!-- Base Owned Section -->
                        <div class="border border-border rounded-lg p-4 lg:col-span-1">
                            <h3 class="text-md font-medium mb-3">Base Owned</h3>
                        ...
                        <!-- Bags Section -->
                        <div class="border border-border rounded-lg p-4 lg:col-span-3">
                            <div class="flex justify-between items-center mb-3">
                                <h3 class="text-md font-medium">Bags</h3>
                                <button
                                    onclick={() => addBoxType(material.id)}
                                    class="text-accent hover:text-accent-bright text-sm flex items-center gap-1"
                                >
                            ...
                            {#if material.boxes?.length}
                                <div class="space-y-3">
                                    {#each material.boxes as box, index}
                                        <div class="flex flex-wrap items-center gap-3 p-3 bg-bg-secondary rounded-lg">
                                            ...
                                            <div class="flex-1 min-w-[80px]">
                                                <label class="block text-xs font-medium text-muted mb-1">Size</label>
                                                <NumberInput
                                                    value={box.size}
                                            ...
                                            <div class="flex-1 min-w-[80px]">
                                                <label class="block text-xs font-medium text-muted mb-1">Owned</label>
                                                <NumberInput
                                                    value={box.owned}
                                            ...
                                            <button
                                                ...
                                                class="text-red hover:text-red-bright p-1"
                                                title="Remove bag"
                                            >
                            ...
                            {:else}
                                <p class="text-sm text-muted italic">No bags defined</p>
                            {/if}
                        </div>
                    </div>
                    ...
                    <div class="mt-4 pt-3 border-t border-border">
                        <div class="flex justify-between items-center">
                            <span class="font-medium text-muted">Total Owned:</span>
    ...
    <div class="card p-4">
        <h3 class="text-md font-semibold mb-2">Quick Actions</h3>
